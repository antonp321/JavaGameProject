...
public class LevelFour extends Level {
    private final static int levelNumber = 4;
    private final static String levelTitle = "Dont let them reach it.";
    private final static BufferedImage fourthLevelBackground = ImageLoader.loadImage("/images/LevelFourBackground.jpg");
    private final static Image fourthLevelBackgroundOfDeath = ImageLoader.loadImage("/images/LevelFourBackgroundOfDeath.jpg");
    ...
    public LevelFour(){
        super(levelTitle, fourthLevelBackground, levelNumber, fourthLevelBackgroundOfDeath);
        this.enemy1 = new Firemaw4(100, 45);
        this.enemy2 = new Firemaw4(700, 45);
        this.enemy3 = new Razorgore1(100, 145);
        this.enemy4 = new Flamegor5(700, 145);
        this.enemy5 = new Flamegor5(100, 245);
        this.enemy6 = new Broodlord3(700, 245);

        this.enemy1.setIsMovingRight(true);
        this.enemy2.setIsMovingLeft(true);

        this.enemy3.setIsMovingRight(true);
        this.enemy4.setIsMovingLeft(true);

        this.enemy5.setIsMovingRight(true);
        this.enemy6.setIsMovingLeft(true);
    }
    ...
    private void enemy1MovingRotaions(Spaceship enemy){
        if(enemy.getObjectX() > 340 && enemy.getHealth() > 0){
    ...
    private void enemy2MovingRotaions(Spaceship enemy){
        if(enemy.getObjectX() < 420 && enemy.getHealth() > 0){

            enemy.setIsMovingRight(true);
            enemy.setIsMovingLeft(false);
        }
        if(enemy.getObjectX() > 740 && enemy.getHealth() > 0){
    ...
    private void enemy4MovingRotaions(Spaceship enemy){
        if(enemy.getObjectX() < 50 && enemy.getHealth() > 0){
    ...
    public void update(){
        ...
        if(super.getPlayer().getCurrentWidthPos() == 800){
            PhaseManager.setCurrentPhase(new PhaseForLevels(new LevelFive()));
            PhaseManager.setCurrentLevel(new LevelFive());
